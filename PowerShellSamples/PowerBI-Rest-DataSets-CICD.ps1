...
Write-Host "***URI used to update creads:  $($uri)"
$body = @"
{
    "credentialDetails": {
...
Write-Host "****Results from Creds updated for datasource: $datasourceId Update Results: $results"


#Refresh Dataset after creds updated
#Refresh DataSet

Write-Host "****Refresh DataSet****"
$contentType = "application/json"     
...
$results = Invoke-WebRequest @parms 
Write-Host "******Results from Refresh Dataset: $datasetId refresh request $results"
